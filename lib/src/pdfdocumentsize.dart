...
class PDFDocumentSize  {
  ...
  PDFDocumentSize({this.size,this.landscape:false,this.width, this.height}){
    if((size == null) && (width==null || height==null)){
      throw Exception("Either a size MUST be specified ot the width and height MUST be provided");
    }
  }
  ...
  get paper {
    ...
    switch(size){
      ...
      case DocumentPaperSize.letter:
        return (landscape)?PDFPageFormat.letter.landscape:PDFPageFormat.letter;
      case DocumentPaperSize.legal:
        return (landscape)?PDFPageFormat.legal.landscape:PDFPageFormat.legal;
